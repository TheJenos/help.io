                        ...
                        <div class="container" style="min-height: 548px;">
                            ...
                            <?php } else { ?>
                                <div id='reqs' class="dialogbox">
                                    <div class="well row">
                                        <center>
                                            <h2 class="col-md-5" style="margin-top: 45px;">Please Create A Account 
                                                </br> Or 
                                                </br> Sign Up 
                                            </h2>
                                            <form class="col-md-7" style="border-left: 1px solid #00365a;text-align: left;" role="form" id="myform" action="backend.php" method="POST" novalidate="" >
                ...
                <div class="row"  >
                    <div class="container" ng-controller="userinfo">
                        <div class="dialogbox" id="editprofile" style="display:none;">
                            <div class="well row" style="overflow-y:scroll;height: 400px;">
                                <center>
                                    <form class="col-md-6" style="border-right: 1px solid #00365a;text-align: left;" role="form" id="myform" action="backend.php" method="POST" novalidate="" >
                                        <div class="form-group">
                                            <label for="email">User Name</label>
                                            <input type="text" name="username" class="form-control simple" id="user" ng-model="Nuser.Uname" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="pwd">Profile Description</label>
                                            <textarea class="simple" ng-model="Nuser.Udiscription" style="padding: 5px;text-align: left;width:100%;height:200px"></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div style="text-align: right">
                                            <input type="button" id="loginbtn" name="login" ng-click="updatepro()" class="simple" value="Save">
                                        </div>
                                    </form>
